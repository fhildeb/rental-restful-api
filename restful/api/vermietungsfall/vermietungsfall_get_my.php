<?php
    /*
    -----------------------------------------------
    Abfrage-Skript, welches alle Vermietungsfälle 
    zu einem Kunden ausgiebt welche nicht
    abgebrochen wurden
    @author: fhildeb
    -----------------------------------------------
    */
    ...
    */
    ...
    //Leeren Vermietungsfall, Fahrzeug für Inhalt der Abfragen anlegen
    ...
    */
    if(isset($_GET['mieter_id']) && is_numeric($_GET['mieter_id'])){
        ...
        echo json_encode(
            array('message' => '1', 'text' => 'mieter_id missing or includes invalid characters')
        ); 
        die();
    }
    ...
    if($kunde->vorname == ""){
        echo json_encode(
            array('message' => '1', 'text' => 'mieter_id does not exist')
        ); 
        die();
    }

    //Vermietungsfälle der Person anzeigen
    $ergebnis = $vermietungsfall->get_my();
    ...
    */
    ...
    {
        echo json_encode(array('message' => '1', 'text' => 'Keine gemeinsamen Vermietungsfälle vorhanden'));
    }
?>